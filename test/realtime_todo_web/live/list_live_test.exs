defmodule RealtimeTodoWeb.ListLiveTest do
  use RealtimeTodoWeb.ConnCase

  import Phoenix.LiveViewTest
  import RealtimeTodo.TodoFixtures

  @create_attrs %{list: "some list", title: "some title", completed: true}
  @update_attrs %{list: "some updated list", title: "some updated title", completed: false}
  @invalid_attrs %{list: nil, title: nil, completed: false}
